...
exports.run = (client, message, params) => {
  ...
  var konum = ''
   ...
   .addField('» Üyeler ['+message.guild.memberCount+']', `${client.emojis.get('497040317552394241')}Çevrimiçi: ${message.guild.members.filter(m => m.user.presence.status === "online").size} \n${client.emojis.get('497040545957543936')}Rahatsız Etmeyin: ${message.guild.members.filter(m => m.user.presence.status === "dnd").size} \n${client.emojis.get('497040874010837012')}Boşta: ${message.guild.members.filter(m => m.user.presence.status === "idle").size} \n${client.emojis.get('497041097101410307')}Çevrımdışı/Görünmez: ${message.guild.members.filter(m => m.user.presence.status === "offline").size} \n${client.emojis.get('497041350651412480')}Bot: ${message.guild.members.filter(m => m.user.bot).size}`, true)
   ...
   .addField('» Roller ['+message.guild.roles.size+']', '`smd!roller` yazarak görebilirsiniz.', true)
   .addField('» Emojiler ['+message.guild.emojis.size+']', '`smd!emojiler` yazarak görebilirsiniz.', true)
